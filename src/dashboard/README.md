...
- [设计基线](../../docs/design/大屏设计基线.md)：布局、颜色、动效与版本依据。
- [状态协同需求](../../docs/product/02-大屏驱动的状态协同需求.md)：由大屏反推的功能。
- [工程与数据库设计](../../docs/engineering/大屏状态服务与数据库设计.md)：模块、数据表与供数接口。
- [内网部署方案](../../deploy/README.md)：依赖、离线包与恢复。
- [联网开发核查](../../docs/research/07-大屏内网网站开发核查.md)：官方依据、文档修正与未验证项。
